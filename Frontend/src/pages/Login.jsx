...
const Login = () => {
    ...
    const handleRegistration = async (type) => {
      ...
      // Basic validations
      if (!inputData.email || !inputData.email.includes("@") || !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(inputData.email)) {
      ...
      if (type === "signup" && (!inputData.name || inputData.name.trim().length < 2)) {
    ...
    }, [registerIsLoading, registerData, registerError, loginIsLoading, loginData, loginError, navigate]);
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-2">
                            ...
                            <div className="space-y-1">
                                ...
                                <Select onValueChange={handleRoleChange} defaultValue={signupInput.role}>
                        ...
                        <CardFooter>
                            <Button className=" bg-sky-800 w-full" disabled={registerIsLoading} onClick={() => handleRegistration("signup")}>
                                {registerIsLoading ? (
                                    <>
                    ...
                    <Card>
                        ...
                        <CardFooter>
                            ...
                            >
                                {loginIsLoading ? (
                                    <>
                                        <Loader2 className="animate-spin mr-2" size={14} /> Please wait
                                    </>
                                ) : (
                                    "Login"
                                )}
